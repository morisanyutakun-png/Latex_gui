...
export const PLANS: Record<PlanId, PlanDef> = {
  ...
  pro: {
    ...
    features: [
      ...
      "類題ジェネレータ — 1ボタンで何枚でも類題を量産 (5スタイル切替・無制限)",
    ...
    featuresEn: [
      ...
      "Variant Studio — one-tap, unlimited variants (5 styles)",
    ...
    addedFeatures: [
      ...
      "類題ジェネレータ を解放 (1ボタンで何枚でも類題を量産・5スタイル切替)",
    ...
    addedFeaturesEn: [
      ...
      "Variant Studio unlocked — one-tap, unlimited variants (5 styles)",
