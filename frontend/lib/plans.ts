...
export const PLANS: Record<PlanId, PlanDef> = {
  free: {
    ...
    featuresEn: [
      ...
      "Variant generation & prompt boost: 1 free trial",
    ],
  },
  starter: {
    id: "starter",
  ...
  pro: {
    ...
    featuresEn: [
      ...
      "Variant generation & prompt boost (REM-style, unlimited)",
    ...
    addedFeatures: [
      ...
      "類題自動生成 / プロンプト強化 を無制限に解放 (REM ノウハウで教材構造を自動整形)",
      "採点・自動採点 (OMR)",
      "PDF・画像取り込み (OCR)",
      "バッチ処理 (最大100行)",
      "PDF出力 優先処理",
    ...
    addedFeaturesEn: [
      ...
      "Unlimited variant generation & prompt boost (REM-style auto-structuring)",
      "Grading & auto-scoring (OMR)",
      "PDF & image import (OCR)",
      "Batch processing (up to 100 rows)",
