...
const ja = {
  ...
  "feat.ai.desc": "「問題を5つ追加して」と話すだけ。AIが文書を自動生成・編集",
  ...
  "doc.editor.visual.type_here": "ここをクリックして本文を追加",
  "doc.editor.visual.insert_text": "テキストを挿入",
  "doc.editor.visual.insert_text.tooltip": "新しい段落を文末に追加 (クリック後そのまま入力できます)",
  ...
  "side.tooltip.visual": "直接編集パネル (中央の紙) を開く / 閉じる",
  "side.label.ai": "AI",
  "side.label.scan": "読取",
  "side.label.figure": "図",
...
const en = {
  ...
  "feat.ai.desc": "Just say \"Add 5 problems.\" AI automatically generates and edits your document.",
  ...
  "doc.editor.visual.type_here": "Click here to add a paragraph",
  "doc.editor.visual.insert_text": "Insert text",
  "doc.editor.visual.insert_text.tooltip": "Append a new paragraph at the end of the document",
  ...
  "side.tooltip.visual": "Toggle the visual editing panel (center paper)",
  "side.label.ai": "AI",
