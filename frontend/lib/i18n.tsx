...
const ja = {
  ...
  "features.h2": "なぜ LaTeX PDF Maker？",
  ...
  "feat.factory.title": "教材工場",
  "feat.factory.desc": "テンプレート × CSV変数で、数十〜数百のPDFを一括量産",
  "feat.advanced.title": "上級者モード",
  "feat.advanced.desc": "LaTeXプリアンブルやカスタムコマンドを直接編集できるフック機能",
...
const en = {
  ...
  // Features
  "features.label": "Features",
  "features.h2": "Why LaTeX PDF Maker?",
  ...
  "feat.factory.title": "Batch Factory",
  "feat.factory.desc": "Combine templates with CSV variables to produce hundreds of PDFs at once.",
  "feat.advanced.title": "Advanced Mode",
  "feat.advanced.desc": "Directly edit the LaTeX preamble and define custom commands with hook support.",
