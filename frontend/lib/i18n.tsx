...
const ja = {
  ...
  "side.tooltip.preview": "印刷プレビューを開く / 閉じる",
  ...
  "chat.quick.create": "新規プリント",
  "chat.quick.create.prompt": "二次関数の問題を5問とその解答を含む数学プリントを作って",
  "chat.quick.math": "数式を追加",
  "chat.quick.math.prompt": "本文に数式を3つ追加して、それぞれ説明をつけて",
  "chat.quick.table": "表を整える",
  "chat.quick.table.prompt": "本文中の表を見やすく booktabs スタイルに整えて",
  "chat.quick.fix": "エラーを修正",
  "chat.quick.fix.prompt": "コンパイルエラーを直して、プレビューが通るようにして",
  "chat.send": "送信 (Enter)",
  ...
  "welcome.card.ai.desc": "「二次関数の問題を5問」などと話しかけるだけで、AIがLaTeXを書きPDFまで仕上げます。",
  "welcome.card.ai.cta": "右パネルのチャットを使う",
  "welcome.card.template.badge": "テンプレート",
  "welcome.card.template.title": "テンプレから始める",
  "welcome.card.template.desc": "学校テスト・塾プリント・解説ノート・論文・レポートなど、整ったレイアウトを瞬時に。",
  "welcome.card.template.cta": "テンプレを選ぶ",
  "welcome.card.scan.badge": "スキャン",
  "welcome.card.scan.title": "画像 / PDF を読み取る",
  "welcome.card.scan.desc": "印刷物・手書き答案・既存PDFをアップロード。AIが内容を読み取りLaTeXに変換します。",
  "welcome.card.scan.cta": "ファイルを選ぶ",
  "welcome.card.grading.badge": "採点モード",
  "welcome.card.grading.title": "答案を採点する",
  "welcome.card.grading.desc": "ルーブリックを編集 → 答案画像をアップロード → AI採点 → 赤入れPDF + フィードバック書出し。",
...
const en = {
  ...
  "chat.model.badge": "EddivomAI · auto",
  "chat.quick.create": "New worksheet",
  "chat.quick.create.prompt": "Build a math worksheet with 5 quadratic equation problems and worked solutions",
  "chat.quick.math": "Add formulas",
  "chat.quick.math.prompt": "Add 3 formulas to the document with a short explanation for each",
  "chat.quick.table": "Tidy table",
  "chat.quick.table.prompt": "Reformat the table in the document using booktabs style for clean rules",
  "chat.quick.fix": "Fix errors",
  "chat.quick.fix.prompt": "Fix any compile errors so the preview renders cleanly",
  ...
  "welcome.card.ai.desc": "Just say \"Build a worksheet with 5 quadratic problems\" — the agent writes LaTeX and previews the PDF for you.",
  "welcome.card.ai.cta": "Use the chat panel",
  "welcome.card.template.badge": "TEMPLATES",
  "welcome.card.template.title": "Start from a template",
  "welcome.card.template.desc": "Quizzes, worksheets, lecture notes, reports, papers — pick a polished layout in one click.",
  "welcome.card.template.cta": "Pick a template",
  "welcome.card.scan.badge": "SCAN / OCR",
  "welcome.card.scan.title": "Scan an image or PDF",
  "welcome.card.scan.desc": "Upload printed material, handwritten answers, or any PDF. The AI reads it and converts to LaTeX.",
  "welcome.card.scan.cta": "Choose a file",
  "welcome.card.grading.badge": "GRADING",
  "welcome.card.grading.title": "Grade student answers",
  "welcome.card.grading.desc": "Edit the rubric → upload answer images → AI grades → export marked PDF + feedback for each student.",
