...
const ja = {
  ...
  "chat.confirm": "確認",
  "chat.clear": "クリア",
  "chat.empty.title": "LaTeX 編集アシスタント",
  "chat.empty.sub": "文書の編集・作成・修正を指示してください",
...
const en = {
  ...
  "chat.clear": "Clear",
  "chat.empty.title": "LaTeX Editing Assistant",
  "chat.empty.sub": "Instruct document edits, creation, and fixes",
