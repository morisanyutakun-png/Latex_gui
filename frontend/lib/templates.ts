...
export interface TemplateDefinition {
  ...
  name: string;
  nameEn: string;
  /** 一行で「成果物が何か」を表す。例: "70 分・100 点・大問 3 題の模試冊子" */
  description: string;
  descriptionEn: string;
  /** 成果物の中身 (目次的に箇条書き)。各エントリは具体的なセクション/要素名。
   *  例: "第1問 数と式・集合と論理 (20点)" */
  contents?: string[];
  contentsEn?: string[];
...
export const TEMPLATES: TemplateDefinition[] = [
  ...
  // ──── Exam: 試験・入試 ────
  {
    ...
    contents: [
      "表紙: 「数学 I・A／第 1 回模擬試験」",
      "情報帯: 試験時間 70 分／配点 100 点／大問 5",
      "注意事項リスト 3 項目",
      "第 1 問: 数と式・集合と論理 (20 点)",
      "第 2 問: 二次関数 (25 点)",
      "第 3 問: 図形と計量 (25 点)",
      "各小問に [○点] バッジ",
      "ページ右上にページ番号ヘッダ",
    ...
    contentsEn: [
      "Cover: “Math I·A / 1st Mock Exam”",
      "Header strip: 70 min / 100 pts / 5 sections",
      "3-item instructions list",
      "Q1: Numbers, sets & logic (20 pts)",
      "Q2: Quadratic functions (25 pts)",
      "Q3: Geometry & trig (25 pts)",
      "Per-subquestion score badges",
      "Page-number header on every page",
    ],
    tag: "入試",
    tagEn: "Exam",
    category: "exam",
  ...
  },
  {
    ...
    contentsEn: [
      "Cover: “○○ University Entrance Exam / Math (Sciences)”",
      "Ruled box for exam time and total points",
      "3-item instructions list",
      "Q1: Cubic curve & line (extrema, area)",
      "Q2: Recurrence and limit of partial sums",
      "Q3: Complex plane and geometry",
      "Centered page numbers in footer",
      "Wide margins, 1.5 line spacing",
    ],
    tag: "二次",
    tagEn: "Univ.",
    category: "exam",
  ...
  },
  {
    ...
    contents: [
      "タイトル: 「数学 II / 第 2 回 定期考査」",
      "氏名・年・組・番号の表組み枠",
      "右上に「得点 / 100」ボックス",
      "受験上の注意 1 行",
      "第 1 問: 計算 3 問 (各 5 点)",
      "第 2 問: 方程式・不等式 3 問 (各 8 点)",
      "第 3 問: 二次関数 2 問 (各 10 点)",
    ],
    contentsEn: [
      "Title: “Math II / 2nd Periodic Test”",
      "Name / year / class / number field table",
      "Top-right “Score / 100” box",
      "One-line test instructions",
      "Q1: 3 calculation items (5 pts each)",
      "Q2: 3 equation/inequality items (8 pts each)",
      "Q3: 2 quadratic-function items (10 pts each)",
    ],
    tag: "テスト",
    tagEn: "Test",
    category: "exam",
  ...
  // ──── Study: 学習・解説 ────
  {
    ...
    contents: [
      "オレンジ帯タイトル: 「二次関数 完全マスター」",
      "★☆☆／★★☆／★★★ の難度バッジ",
      "目標時間 60 分／目安到達点 70 点 表示",
      "基本問題 ★☆☆ ウォームアップ (3 問)",
      "標準問題 ★★☆ 解の配置 (2 問)",
      "応用問題 ★★★ 文字を含む最大最小",
      "「Today's Point」 ポイントまとめ欄",
      "ヘッダ: 塾名 / レッスン番号",
    ],
    contentsEn: [
      "Orange banner title: “Master Quadratic Functions”",
      "★☆☆ / ★★☆ / ★★★ difficulty badges",
      "Target time 60 min / target score 70",
      "Basic ★☆☆ warm-up (3 items)",
      "Standard ★★☆ root placement (2 items)",
      "Advanced ★★★ max/min with parameters",
      "“Today's Point” summary block",
      "Header with school name & lesson #",
    ],
    tag: "塾",
    tagEn: "Cram",
    category: "study",
  ...
  },
  {
    ...
    contentsEn: [
      "Chapter title: “Ch. 3 Applications of Differentiation”",
      "§1 Tangent line equation",
      " · Definition box",
      " · Example box with worked solution",
      " · Red caution marker",
  ...
  },
  {
    ...
    contents: [
      "タイトル: 「三角比 演習プリント」",
      "学年・組・番号・氏名の記入欄",
      "単元バナー: 三角比の定義／正弦定理／余弦定理",
      "【基本】角の値が分かっているケース 2 問",
      "【標準】正弦定理・余弦定理 3 問",
      "【発展】場合分け・図形応用 2 問",
      "ヘッダ: 「演習プリント」",
    ],
    contentsEn: [
      ...
      "Class / number / name fields",
      "Unit banner: definitions, law of sines & cosines",
      "[Basic] 2 known-angle problems",
      "[Standard] 3 sine/cosine law problems",
      "[Advanced] 2 case-split / geometry problems",
      "Header: “Worksheet”",
    ],
    tag: "授業",
    tagEn: "Class",
  ...
  },
  {
    ...
    contents: [
      "タイトル: 「Unit 5: The Power of Curiosity」",
      "Vocabulary 表: 英単語 8 個 + 和訳",
      "Reading passage ボックス (6 行)",
      "Comprehension 問題 3 問",
      "Writing 問題: 自分の興味について 3〜5 文",
      "解答用 4 本線",
      "ヘッダ: 「English Worksheet / Unit 5」",
    ],
    contentsEn: [
      "Title: “Unit 5: The Power of Curiosity”",
      "Vocab table: 8 words with translations",
      "Reading passage box (~6 lines)",
      "3 comprehension questions",
      "Writing prompt: 3–5 sentences",
      "4 answer lines",
      "Header: “English Worksheet / Unit 5”",
    ],
    tag: "英語",
    tagEn: "English",
    category: "study",
  ...
  // ──── Document: 文書・レポート ────
  {
    ...
    contentsEn: [
      ...
      "1. Introduction",
      "2. Related work",
      "3. Proposed method (with loss equation)",
      "4. Experiments (results table)",
      "5. Conclusion",
      "Bibliography with 2 entries",
      "Header with section name & page #",
    ],
    tag: "論文",
    tagEn: "Paper",
    category: "document",
  ...
  },
  {
    ...
    contentsEn: [
      "Cover: “Technical Report / Project Aurora”",
      "Table of contents",
      "Ch. 1 System overview",
      " · Background (3 issues)",
      " · Note box + glossary table",
      "Ch. 2 Architecture",
      " · Overview + API endpoint table",
      "Ch. 3 Math model (transfer function)",
      "Header with chapter name & page #",
    ],
    tag: "報告書",
    tagEn: "Report",
    category: "document",
  ...
  // ──── Slide ────
  {
    ...
    contents: [
      "Slide 1: タイトル / 著者 / 所属",
      "Slide 2: 背景と目的 (箇条書き 3)",
      "Slide 3: 提案手法 + 目的関数の式",
      "Slide 4: 実験結果 (3 行の比較表)",
      "Slide 5: 結論と今後の課題",
      "Slide 6: 「ご清聴ありがとうございました」(standout)",
      "テーマ: metropolis (紫系アクセント)",
    ],
    contentsEn: [
      "Slide 1: Title / author / affiliation",
      "Slide 2: Background & goal (3 bullets)",
      "Slide 3: Proposed method + objective equation",
      "Slide 4: Results (3-row comparison table)",
      "Slide 5: Conclusion & future work",
      "Slide 6: “Thank you” standout slide",
      "Metropolis theme with purple accents",
    ],
    tag: "発表",
    tagEn: "Slides",
    category: "slide",
  ...
  // ──── Letter ────
  {
    ...
    contentsEn: [
      "Top-right date",
      "Recipient: company / title / name",
      "Centered title: “○○ Announcement”",
      "Opening (haikei) + greeting",
      "Body of announcement",
      "Centered ‘記’ marker",
      "Table: date / place / agenda / items",
      "Contact info + closing (keigu) + sender",
    ],
    tag: "手紙",
    tagEn: "Letter",
    category: "letter",
