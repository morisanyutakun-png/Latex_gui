...
export const TEMPLATES: TemplateDefinition[] = [
  ...
  // ──── Exam: 試験・入試 ────
  {
    ...
    description: "大学入学共通テスト風の問題冊子。紺基調の大問ボックスと配点バッジ付き",
    descriptionEn: "Japanese national entrance exam style. Navy color blocks with score badges",
    highlights: [
      "色: 紺 + コバルト",
      "大問: tcolorbox / 配点バッジ",
      "ヘッダ: ページ番号付き",
    ...
    highlightsEn: [
      "Navy + cobalt palette",
      "Boxed question blocks with score badges",
      "Page header with numbering",
      "3 sample problem sections",
    ],
    tag: "入試",
    tagEn: "Exam",
    category: "exam",
  ...
  },
  {
    ...
    description: "国公立大学二次試験風。装飾を抑えた格調高いモノクロ問題冊子",
    descriptionEn: "Japanese national university 2nd-stage style. Monochrome, formal booklet",
    highlights: [
      "色: モノクロ (黒のみ)",
      "見出し: 罫線 + 大問番号",
      "余白広め / 1.5 行間",
    ...
    highlightsEn: [
      ...
      "Rule-lined section headings",
      "Wide margins, 1.5 line spacing",
      "3 substantial sample problems",
    ],
    tag: "二次",
    tagEn: "Univ.",
    category: "exam",
  ...
  },
  {
    ...
    name: "学校テスト",
    nameEn: "School test",
    description: "定期考査向け。氏名欄・得点欄・大問見出し付きのシンプル構成",
    descriptionEn: "For periodic tests. Includes name/score fields and clear problem headers",
    highlights: [
      "氏名・組・番号欄",
      "得点ボックス",
      "大問見出しに左罫線アクセント",
    ...
    highlightsEn: [
      ...
      "Score box",
      "Red side-bar problem headers",
      "3 sections: calc / equations / functions",
    ],
    tag: "テスト",
    tagEn: "Test",
    category: "exam",
  ...
  // ──── Study: 学習・解説 ────
  {
    ...
    description: "オレンジ基調の元気な塾プリント。難度バッジ・基本/応用ボックス付き",
    descriptionEn: "Energetic orange cram-school worksheet. Difficulty badges and box-typed sections",
    highlights: [
      "色: 朱赤 + 紺 (アクセント)",
      "タイトル帯 / 難度バッジ ★☆",
      "基本ボックス / 応用ボックス",
    ...
    highlightsEn: [
      "Vermilion + navy accent palette",
      "Title banner & ★ difficulty badges",
      "Basic & applied problem boxes",
  ...
  },
  {
    ...
    name: "解説ノート",
    nameEn: "Lecture note",
    description: "定義・定理・例題・練習を色付きボックスで整理した学習ノート風",
    descriptionEn: "Study notebook with colored boxes for definitions, theorems, examples, exercises",
    highlights: [
      "色: ティール + 海色",
      "定義・定理・例題ボックス",
      "注意マーカー (赤)",
    ...
    highlightsEn: [
      ...
      "Caution markers (red)",
      "Sample chapter on differentiation",
    ],
    tag: "ノート",
    tagEn: "Notes",
    category: "study",
  ...
  },
  {
    ...
    name: "演習プリント",
    nameEn: "Worksheet",
    description: "授業用の練習問題。基本→標準→発展のレベル別構成",
    descriptionEn: "Practice worksheet with basic → standard → advanced levels",
    highlights: [
      "色: ティール / スカイ",
      "単元バナー",
      "レベル別 (基本/標準/発展)",
  ...
  },
  {
    ...
    description: "英文読解+語彙+設問の三段構成。バイリンガル単語表付き",
    descriptionEn: "Reading + vocabulary + comprehension. Includes bilingual vocab table",
    highlights: [
      "色: モスグリーン + クリーム",
      "単語表 (英語/和訳)",
      "Reading passage ボックス",
      "Comprehension + Writing 問題",
    ],
    highlightsEn: [
      "Moss-green + cream palette",
      "Bilingual vocabulary table",
      "Reading passage box",
      "Comprehension + writing tasks",
    ],
    tag: "英語",
    tagEn: "English",
    category: "study",
  ...
  // ──── Document: 文書・レポート ────
  {
    ...
    name: "レポート・論文",
    nameEn: "Report / paper",
    description: "学術的なレポート・短い論文。abstract / 参考文献付き",
    descriptionEn: "Academic report or short paper with abstract and bibliography",
    highlights: [
      "色: ネイビーアクセント",
      "abstract / 参考文献入り",
      "fancyhdr ヘッダ",
    ...
    highlightsEn: [
      "Navy accent palette",
      "Abstract + bibliography included",
      "fancyhdr header",
      "Sample table and equations",
    ],
    tag: "論文",
    tagEn: "Paper",
    category: "document",
  ...
  },
  {
    ...
    description: "章立て構造の長い報告書。目次・章タイトル装飾・注記ボックス付き",
    descriptionEn: "Long technical report with chapters, decorated titles, and note boxes",
    highlights: [
      "色: 深いティール",
      "Chapter 装飾見出し",
      "目次・注記ボックス",
    ...
    highlightsEn: [
      ...
      "TOC and note boxes",
      "Sample API table and math model",
    ],
    tag: "報告書",
    tagEn: "Report",
    category: "document",
  ...
  // ──── Slide ────
  {
    ...
    name: "プレゼンテーション",
    nameEn: "Presentation",
    description: "学会発表・講義スライド。metropolis テーマでクリーンに",
    descriptionEn: "Conference talks and lecture slides with the metropolis theme",
    highlights: [
      "テーマ: metropolis",
      "16:9 ワイド",
      "タイトル / 提案 / 結果 / 結論 構成",
    ...
    highlightsEn: [
      "metropolis theme",
      "16:9 widescreen",
      "Title → method → results → conclusion",
      "Standout closing slide",
    ],
    tag: "発表",
    tagEn: "Slides",
    category: "slide",
  ...
  // ──── Letter ────
  {
    ...
    description: "フォーマルな日本語ビジネスレター。拝啓〜敬具の体裁完備",
    descriptionEn: "Formal Japanese business letter with proper opening and closing phrases",
    highlights: [
      "和文ビジネス書式",
      "拝啓 / 敬具",
      "記・以上の体裁",
    ...
    highlightsEn: [
      ...
      "Centered ‘記’ block",
      "1.45 line spacing for readability",
    ],
    tag: "手紙",
    tagEn: "Letter",
    category: "letter",
