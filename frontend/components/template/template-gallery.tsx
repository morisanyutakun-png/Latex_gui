...
import { EditorMockup, FigureDrawMockup, M, SERIF } from "./lp-mockups";
...
// 不要 import を削除した後の lucide-react 一覧 (template-gallery 本体で使うものだけ)。
// EditorMockup / FigureDrawMockup / M に閉じたアイコンは lp-mockups 側に移したので除外。
import {
  ArrowRight,
  ChevronRight,
  FileText,
...
// SERIF / M は lp-mockups.tsx から再利用 (重複定義を排除)
