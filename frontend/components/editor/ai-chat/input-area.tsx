...
export function InputArea({
  ...
  return (
    <div className="px-3 pb-3 pt-2 shrink-0 chat-aurora-panel">
      <div className="chat-input-aurora rounded-2xl overflow-hidden">
        <div className="flex items-end gap-1.5 px-3 py-2.5">
          ...
          <Textarea
            ...
            className="min-h-[24px] max-h-32 text-[14px] resize-none flex-1 bg-transparent border-none shadow-none p-0 focus-visible:ring-0 focus:outline-none outline-none placeholder:text-foreground/30 leading-relaxed"
            disabled={isChatLoading}
          />
      ...
      <p className="text-center text-[10px] text-muted-foreground/30 mt-1.5 tracking-wider font-mono uppercase">
